...
st.set_page_config(page_title="VedicChat", page_icon="📚", layout="wide")
...
def main():
    ...
    if st.text_input("Please enter your OpenAI API Key to continue", value=st.session_state["OPENAI_API_KEY"], key="input_OPENAI_API_KEY", type="password"):
        if (
    ...
    st.subheader("Upload your vedic texts")
    st.file_uploader(
        "Upload document",
        type=["pdf"],
        key="file_uploader",
    ...
    st.divider()
    st.markdown("Source code: [Github](https://github.com/santosh-gkg/vedicchat)")
